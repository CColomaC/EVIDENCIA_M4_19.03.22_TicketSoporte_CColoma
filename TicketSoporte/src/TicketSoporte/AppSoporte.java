...
public class AppSoporte {
	...
	public static void inicializar() {
		...
		*/
		...
		//ESPECIALISTAS
		String rutEspecialista = "8.309.918-6";
		String nombreEspecialista = "Luis Vega";
		Especialista nuevoEspecialista = new Especialista(rutEspecialista,nombreEspecialista);
		especialista.add(nuevoEspecialista);
		
		String rutEspecialista2 = "11.298.421-5";
		String nombreEspecialista2 = "Ana Peña";
		...
		String rutSoporte = "13.518.744-2";
		String nombreSoporte = "Christian Coloma";
		...
		String rutSoporte2 = "14.602.476-K";
		String nombreSoporte2 = "Vanessa Vega";
		String usuarioSoporte2 = "vane";
		...
		String descripcionTicket = "Ticket ejemplo";
		...
		String descripcionTicket2 = "Ticket ejemplo 2";
	...
	private static void menu() {
		...
		scanner.nextLine(); // evita un error donde se consume un nextLine()
	}
	...
	public static void editarTicket(int numeroTicket) {
		...
		// Mientras el objeto editarTicket sea nulo, repetirá el fragmento de código
		do {
			
			// 0 es el default enviado por el menú utilizado para un ejemplo, por tanto, invalido. Debe ser reasignado.
			if(numeroTicket == 0 ) {
		...
		// Una vez definido el número de ticket, pasamos a la edición proper.
		// Define el estado del ticket y hace algo distinto en cada caso. 
		//Si se comete un error, se definira el ticket como "Abierto" por defecto.
